...
// Иконки для печати и документов
...
// Иконки для времени и календаря
...
// Иконки для воды и инфраструктуры
...
// Иконки для настроек и управления
...
// Дополнительные иконки для интеграций
...
export const KeyIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4l-1-1v-2.586A6 6 0 016.257 6.257L10.5 2H21a2 2 0 012 2v5a2 2 0 01-2 2z" />
    </svg>
);
...
export const TruckIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <rect width="1" height="1" x="1" y="3"></rect><path d="M7 18V6a2 2 0 0 1 2-2h6l4 4v10a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2Z"></path><path d="M9 18v4"></path><path d="M15 18v4"></path><path d="M7 8h10"></path><path d="M7 12h6"></path>
    </svg>
);
...
export const DocumentDuplicateIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <rect width="14" height="20" x="8" y="2" rx="2" ry="2"></rect><path d="M4 16V4a2 2 0 0 1 2-2h10"></path>
    </svg>
);
...
// Иконки для уведомлений и объявлений
...
export const FileSpreadsheetIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><path d="M8 13h1v4"></path><path d="M12 13h2v4h-2z"></path><path d="M12 15h2"></path><path d="M16 13h1v4"></path>
    </svg>
);

export const FlaskConicalIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M8.5 2h7l5.3 16H3.2L8.5 2z"></path><path d="M14.5 2h-5"></path><path d="M6 18h12"></path><path d="M8.5 14h7"></path>
    </svg>
);
...
export const LayersIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polygon points="2 17 12 22 22 17"></polygon><polygon points="2 12 12 17 22 12"></polygon>
    </svg>
);
...
export const GavelIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="m14 12-8.5 8.5c-.83.83-2.17.83-3 0 0 0 0 0 0 0a2.12 2.12 0 0 1 0-3L11 9"></path><path d="m15 11 1 1"></path><path d="m12 14 1 1"></path><path d="m18 8 1 1"></path><path d="m17 7 1 1"></path><path d="m9 2-3.5 3.5c-.83.83-2.17.83-3 0 0 0 0 0 0 0a2.12 2.12 0 0 1 0-3L6 2h3"></path><path d="M15 2.5 19 6"></path><path d="m22 9-4.5 4.5"></path>
    </svg>
);
...
export const FuelIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <line x1="3" y1="22" x2="3" y2="16"></line><line x1="3" y1="12" x2="3" y2="10"></line><path d="M3 10V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-5"></path><path d="M14 10h.01"></path><path d="M10 10h.01"></path><path d="M6 10h.01"></path><path d="M10 18h4"></path><path d="M12 14v4"></path><path d="M12 10a2 2 0 0 1 2 2v2"></path>
    </svg>
);
...
export const DataExchangeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M16 3h5v5"></path><path d="M21 3l-7.5 7.5"></path><path d="M8 21H3v-5"></path><path d="M3 21l7.5-7.5"></path>
    </svg>
);
