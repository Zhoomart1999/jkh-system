...
const navItems: NavItem[] = [
    ...
    { path: '/engineer/map', label: 'Карта (ГИС)', icon: <LayersIcon className="w-5 h-5" />, roles: [Role.Engineer, Role.Controller] },
    ...
    { path: '/engineer/water-quality', label: 'Качество воды', icon: <FlaskConicalIcon className="w-5 h-5" />, roles: [Role.Engineer, Role.Controller] },
